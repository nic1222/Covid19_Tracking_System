 ...
 * @author user
 */
@WebServlet(name = "SearchCountryTotalCases", urlPatterns = {"/SearchCountryTotalCases"})
public class SearchCountryTotalCases extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TotalCases> allTotalCasesOld = Calculation.groupAllCases(confirmedCaseList, deathCaseList, recoveredCaseList);
        String s = request.getParameter("country");
        List<TotalCases> allTotalCases = Calculation.searchCountryTotalCases(allTotalCasesOld, s);
